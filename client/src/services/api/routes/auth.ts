...
export default {
  ...
  addEmployee: (user: any) => axios.post(`${auth.base}/bloodbank/addEmployee`, user),
  ...
  getBloodBank2: () => axios.get(`${auth.base}/bloodbank/allBloodBankz`),
  getBloodBankDetails: (jwt: string) => axios.get(`${auth.base}/employee/employeeBloodBankDetails/${jwt}`),
  deleteFAQ: (jwt: string, faqId: any) => axios.post(`${auth.base}/bloodbank/deleteFAQ/${jwt}`, faqId),
  getFAQ: () => axios.get(`${auth.base}/bloodbank/faq`),
  postFAQ: (jwt: string, body: any) => axios.post(`${auth.base}/bloodbank/addFAQ/${jwt}`, body),
  editFAQ: (jwt: any, body: any) => axios.put(`${auth.base}/bloodbank/editFAQ/${jwt}`, body),
  deleteNews: (jwt: string, newsId: any) => axios.post(`${auth.base}/bloodbank/deleteNews/${jwt}`, newsId),
  ...
  getRegistered: (actionId: any) => axios.get(`${auth.base}/bloodbank/getDonorsForAction/${actionId}`),
};
